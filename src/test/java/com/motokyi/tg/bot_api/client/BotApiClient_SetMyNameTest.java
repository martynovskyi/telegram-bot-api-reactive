...
public class BotApiClient_SetMyNameTest extends BotClientTest {
    ...
    void successful() {
        stubFor(
                get(urlPathEqualTo(ApiUrls.SET_MY_NAME))
    ...
    @Test
    void unauthorized() {
        unauthorizedTest(botClient.setMyName(BOT_NAME, null), ApiUrls.SET_MY_NAME, HttpMethod.GET);
    }

    @Test
    void tooManyRequests() {
        tooManyRequestsTest(
                botClient.setMyName(BOT_NAME, LANGUAGE_CODE), ApiUrls.SET_MY_NAME, HttpMethod.GET);
    }
}
