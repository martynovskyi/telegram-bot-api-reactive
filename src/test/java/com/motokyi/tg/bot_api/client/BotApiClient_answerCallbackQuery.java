...
public class BotApiClient_answerCallbackQuery extends BotClientTest {
    ...
    void successful() {
        ...
        stubFor(post(urlEqualTo(ApiUrls.ANSWER_CALLBACK_QUERY))
                .withRequestBody(matchingJsonPath(jsonPath(ApiProperties.CALLBACK_QUERY_ID), equalTo(CALLBACK_ID))
                        .and(matchingJsonPath(jsonPath(ApiProperties.TEXT), equalTo(answerCallbackQuery.getText())))
                        .and(matchingJsonPath(jsonPath(ApiProperties.SHOW_ALERT), equalTo("true")))
                        .and(matchingJsonPath(jsonPath(ApiProperties.URL), equalTo(answerCallbackQuery.getUrl())))
